...
function AccountsForm({setAddAccountClicked}) {
...
<div className="flex justify-between">
    ...
    <span onClick={()=>{setAddAccountClicked(false)}} className="cursor-pointer">❌</span>
</div>


      <div>
        <label className='block mb-1' htmlFor='accountName'>
          Account Name <span className='text-rose-500'>*</span> <span className='text-rose-500'>{errors.accountName?.message}</span>
        </label>
        <input type='text' id='accountName' className='form-input  w-full text-slate-600' {...register("accountName")} />
      </div>

      {/* Drop Down Account Types */}
      <div>
        <label className='block  mb-1' htmlFor='accountType'>
      ...
      {/* Drop Down TimeZone */}
      <div>
        <label className='block  mb-1' htmlFor='timeZone'>
